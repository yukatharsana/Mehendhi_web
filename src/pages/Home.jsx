        ...
        <>
                ...
                <div class="carousel-inner">
                    <div class="carousel-item active" data-bs-interval="1000">
                        ...
                        <div class="carousel-caption d-none d-md-block">
                            <h5 className='home-h5'>The Best Henna shop in Town</h5>
            ...
            <div className="container text-center">
                ...
                <div className="d-flex align-items-center justify-content-center ">
                    <Link to="/Shophenna" className="d-block btn mx-4 btn-home-henna">SHOP HENNA</Link>
                    <Link to="/Bookhenna" className="d-block btn mx-4 btn-home-henna">BOOKSERVICES</Link>
                    <Link to="/Learnhenna"className="d-block btn mx-4 btn-home-henna">HENNA CLASSES</Link>
                </div>
            </div>
